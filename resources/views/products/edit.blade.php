            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="name" value="{{ old('name', $product->name) }}" required class="premium-input @error('name') border-[hsl(var(--danger))] @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" name="sku" value="{{ old('sku', $product->sku) }}" required class="premium-input @error('sku') border-[hsl(var(--danger))] @enderror">
                ...
                <div class="border-t border-[hsl(var(--border))] pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="unit" value="{{ old('unit', $product->unit) }}" required class="premium-input @error('unit') border-[hsl(var(--danger))] @enderror">
                        ...
                        <div>
                            ...
                            <input type="number" name="minimum_stock_level" value="{{ old('minimum_stock_level', $product->minimum_stock_level) }}" min="0" required class="premium-input @error('minimum_stock_level') border-[hsl(var(--danger))] @enderror">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="cost_price" value="{{ old('cost_price', $product->cost_price) }}" min="0" required class="premium-input pl-8 @error('cost_price') border-[hsl(var(--danger))] @enderror">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-[hsl(var(--text-muted))]">$</span>
                                <input type="number" step="0.01" name="selling_price" value="{{ old('selling_price', $product->selling_price) }}" min="0" class="premium-input pl-8 @error('selling_price') border-[hsl(var(--danger))] @enderror">
                            </div>
                ...
                <div class="border-t border-[hsl(var(--border))] pt-6">
                    ...
                    <textarea name="description" rows="3" class="premium-input @error('description') border-[hsl(var(--danger))] @enderror">{{ old('description', $product->description) }}</textarea>
                ...
                <div>
                    <label class="flex items-center gap-2 text-sm font-medium">
                        ...
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $product->is_active) ? 'checked' : '' }} class="rounded border-[hsl(var(--border))] text-[hsl(var(--primary))] focus:ring-[hsl(var(--primary))]">
                        Product is Active
                    </label>
                </div>
            </div>
